...
const MenuButton = () => {
  ...
  return (
    <div className="md:hidden">
      ...
      <AnimatePresence>
        {isMenuExpanded && (
          <motion.div key="menu" initial={{ x: "-100%", opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: "-100%", opacity: 0 }} transition={{ duration: 0.8, ease: "easeInOut" }} className="fixed inset-0 bg-blue-600 flex flex-col items-center justify-between text-white font-semibold z-50 px-8">
